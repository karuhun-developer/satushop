...
import { store } from '@/actions/App/Http/Controllers/Cms/Core/CurrencyController';
    ...
    <Modal v-slot="{ close }">
        <div class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Create a new currency for the application.
            </p>
            ...
            >
                <div class="grid gap-2">
                    ...
                    <InputDescription>
                        The code for the currency (e.g., 'en', 'fr').
                    </InputDescription>
                    <Input
                        id="code"
                        name="code"
                ...
                <div class="grid gap-2">
                    ...
                    <InputDescription>
                        The display name for the currency (e.g., 'English',
                        'French').
                    </InputDescription>
                    <Input
                        id="name"
                ...
                <div class="grid gap-2">
                    ...
                    <RadioGroup name="is_default" default-value="0">
