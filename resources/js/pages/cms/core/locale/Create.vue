...
import { store } from '@/actions/App/Http/Controllers/Cms/Core/LocaleController';
    ...
    <Modal v-slot="{ close }">
        <div class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Create a new locale for the application.
            </p>
            ...
            >
                ...
                <div class="grid gap-2">
                    ...
                    <Select name="direction" default-value="ltr">
