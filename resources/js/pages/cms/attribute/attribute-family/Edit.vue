...
import { update } from '@/actions/App/Http/Controllers/Cms/Attribute/AttributeFamilyController';
...
const selectedAttributeIds = ref<number[]>(
    props.attributeFamily.groups?.map((attr) => attr.attribute_id) || [],
);
</script>
    ...
    <Modal v-slot="{ close }">
        <div class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Edit the attribute family details.
            </p>

            <Form
                v-bind="update.form({ attribute_family: attributeFamily.id })"
                class="mt-6 space-y-6"
                @success="
                    () => {
                        toast.fire({
                            icon: 'success',
                            title: 'Attribute Family updated.',
                        });
                        close();
                    }
                "
            ...
            >
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        required
                        autofocus
                        :default-value="attributeFamily.code"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        required
                        autofocus
                        :default-value="attributeFamily.name"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Select
                        name="status"
                        :default-value="Number(attributeFamily.status)"
                    >
