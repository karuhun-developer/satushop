...
import { update } from '@/actions/App/Http/Controllers/Cms/Shop/ShopController';
...
if (props.shop.translations) {
    props.shop.translations.forEach((translation) => {
        descriptions.value[translation.locale] = translation.description || '';
        names[translation.locale] = translation.name || '';
    });
}

// Default latitude and longitude from shop or Bandung
const latitude = ref<number>(
    props.shop.latitude ? Number(props.shop.latitude) : -6.90389,
);
const longitude = ref<number>(
    props.shop.longitude ? Number(props.shop.longitude) : 107.61861,
);

// Location State
const selectedProvince = ref<string | undefined>(
    props.shop.rajaongkir_province_id
        ? String(props.shop.rajaongkir_province_id)
        : undefined,
);
const selectedCity = ref<string | undefined>(
    props.shop.rajaongkir_city_id
        ? String(props.shop.rajaongkir_city_id)
        : undefined,
);
const selectedDistrict = ref<string | undefined>(
    props.shop.rajaongkir_district_id
        ? String(props.shop.rajaongkir_district_id)
        : undefined,
);
...
<template>
    <Modal v-slot="{ close }">
        <div class="p-6">
            ...
            <Form
                v-bind="update.form({ shop: shop.slug })"
            ...
            >
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="grid gap-2">
                        ...
                        <ImageUploadPreview
                            ...
                            :initial-preview="shop.banner_url"
                        />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    <div class="grid gap-2">
                        ...
                        <Select
                            ...
                            :default-value="
                                shop.rajaongkir_province_id
                                    ? String(shop.rajaongkir_province_id)
                                    : undefined
                            "
                        >
                            <SelectTrigger
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select
                            ...
                            :default-value="
                                shop.rajaongkir_city_id
                                    ? String(shop.rajaongkir_city_id)
                                    : undefined
                            "
                        >
                            <SelectTrigger
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select
                            ...
                            :default-value="
                                shop.rajaongkir_district_id
                                    ? String(shop.rajaongkir_district_id)
                                    : undefined
                            "
                        >
                            <SelectTrigger
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        type="text"
                        class="mt-1 block w-full"
                        :default-value="shop.postal_code"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Select name="status" :default-value="shop.status ? 1 : 0">
